...
import grpc
import time
import dronecore_action.action_pb2 as action_pb2
...
def run():
    ...
    if arm_result.result == action_pb2.ActionResult.SUCCESS:
        print("arming ok")
    else:
    ...
    if takeoff_result.result == action_pb2.ActionResult.SUCCESS:
        print("takeoff ok")
    else:
    ...
    if land_result.result == action_pb2.ActionResult.SUCCESS:
        print("landing ok")
    else:
