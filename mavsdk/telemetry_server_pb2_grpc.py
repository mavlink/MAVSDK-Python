...
if _version_not_supported:
    raise RuntimeError(
        ...
        + " but the generated code in telemetry_server/telemetry_server_pb2_grpc.py depends on"
...
class TelemetryServerServiceStub:
    """
...
class TelemetryServerServiceServicer:
    """
    Allow users to provide vehicle telemetry and state information
    (e.g. battery, GPS, RC connection, flight mode etc.) and set telemetry update rates.
    """
