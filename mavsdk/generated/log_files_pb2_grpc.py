...
from . import log_files_pb2 as log__files__pb2
...
class LogFilesServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetEntries = channel.unary_unary(
                ...
                request_serializer=log__files__pb2.GetEntriesRequest.SerializeToString,
                response_deserializer=log__files__pb2.GetEntriesResponse.FromString,
                )
        self.SubscribeDownloadLogFile = channel.unary_stream(
                '/mavsdk.rpc.log_files.LogFilesService/SubscribeDownloadLogFile',
                request_serializer=log__files__pb2.SubscribeDownloadLogFileRequest.SerializeToString,
                response_deserializer=log__files__pb2.DownloadLogFileResponse.FromString,
                )
...
def add_LogFilesServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetEntries': grpc.unary_unary_rpc_method_handler(
                    servicer.GetEntries,
                    request_deserializer=log__files__pb2.GetEntriesRequest.FromString,
                    response_serializer=log__files__pb2.GetEntriesResponse.SerializeToString,
            ),
            'SubscribeDownloadLogFile': grpc.unary_stream_rpc_method_handler(
                    servicer.SubscribeDownloadLogFile,
                    request_deserializer=log__files__pb2.SubscribeDownloadLogFileRequest.FromString,
                    response_serializer=log__files__pb2.DownloadLogFileResponse.SerializeToString,
            ),
    }
...
class LogFilesService(object):
    ...
    def GetEntries(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/mavsdk.rpc.log_files.LogFilesService/GetEntries',
            log__files__pb2.GetEntriesRequest.SerializeToString,
            log__files__pb2.GetEntriesResponse.FromString,
    ...
    def SubscribeDownloadLogFile(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/mavsdk.rpc.log_files.LogFilesService/SubscribeDownloadLogFile',
            log__files__pb2.SubscribeDownloadLogFileRequest.SerializeToString,
            log__files__pb2.DownloadLogFileResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
