...
class MissionRawService(object):
    ...
    def ClearMission(request,
            ...
            metadata=None):
        """
        Perform a thread - safe operation.
    ...
    def SetCurrentMissionItem(request,
            ...
            metadata=None):
        """
        Sets the specified item to a thread.
    ...
    def SubscribeMissionChanged(request,
            ...
            metadata=None):
        """
        Issues a simple simple. com on a / friction.
